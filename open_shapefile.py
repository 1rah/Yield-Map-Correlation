...
@description:
    convert a shapefile in WGS84 to csv with headers 'easting northing yield'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-kmlfile', nargs = 1, default = None, type=str, help='filter points inside kml boundary (kml must contain a single polygon in WGS84 coords)')
